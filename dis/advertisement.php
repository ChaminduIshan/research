                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-10">
                                    <button class="btn btn-primary btn-lg btn-block">Billboard Advertisements</button>
                                    <br><br>
                                    <button class="btn btn-primary btn-lg btn-block">Youtube Advertisements</button>
                                    <br><br>
                                    <button class="btn btn-primary btn-lg btn-block">Facebook Advertisements</button>
                                    <br><br>
                                    <button class="btn btn-primary btn-lg btn-block">Newspaper Advertisements</button>
                                    <br><br>
                                    <button class="btn btn-primary btn-lg btn-block">Television Advertisements</button>
                                </div>
                                <div class="col-lg-1"></div>
                            </div>
                        </div>
