...
<head>
    ...
    <!-- Custom Styles-->
    <link href="../research/assets/css/custom-styles.css" rel="stylesheet"/>
    <!-- TABLE STYLES-->
    <link href="../research/assets/js/dataTables/dataTables.bootstrap.css" rel="stylesheet"/>
    <!-- Google Fonts-->
    <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css'/>
    <!-- Morris Styles-->
...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            ...
            <?php if (isset ($_SESSION['platform'])&&$_SESSION['platform']=="Admin") {  ?>
                <li>
                <a href="Admin_page1.php" id="menu_dashboard"><i class="fa fa-desktop"></i> Dashboard</a>
                </li>
                <?php } ?>
                ...
                <!--
                    <li id="menu_notification">
                    <a href=""><i class="fa fa-envelope-square"></i> Offers<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="myNotification.php" id="menu_sub_my_note"><i
                                    class="fa fa-plus"></i> Offers</a>
                        </li>
                    </ul>
                </li>
                -->
                ...
                <?php if (isset ($_SESSION['platform'])&&$_SESSION['platform']=="Admin") {  ?>
                <li id="menu_news">
                    <a href=""><i class="fa fa-envelope-square"></i> Creater <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="../research/creator_suj.php" id="menu_sub_add_news"><i
                                    class="fa fa-share-square"></i> type </a>
                        </li>
                        <li>
                ...
                <li id="menu_ads">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <!--
                        <li>
                            <a href="createOfAds.php" id="menu_sub_create_ads"><i
                                        class="fa fa-share-square"></i> offer Ads </a>
                        </li>
                        -->
                ...
                <?php if (isset ($_SESSION['platform'])&&$_SESSION['platform']=="Admin") {  ?>
                <li id="menu_notification">
                    <a href="./researchdew/index.php"><i class="fa fa-user"></i> Billboard System <span class="fa arrow"></span></a>
