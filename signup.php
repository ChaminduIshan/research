...
if(mysqli_query($link, $sql)){
    echo '<div class="alert alert-success">User successfuly Added!!!! </div>';
} else{
                ...
                <div class="panel panel-danger">
                    ...
                    <div class="panel-body">
                        <form method="post" onSubmit="return valid();">
                            ...
                            <div class="form-group">
                                <label>Enter page Name (Channel Name)</label>
                                <input class="form-control" type="text" name="page" autocomplete="off" required />
                            </div>

                            <div class="form-group">
                                <label>Enter page url (Channel url)</label>
                            ...
                            <div class="form-group">
                                <label>platform(ex-Creater or Facebook/Youtube):</label>
                                <input class="form-control" type="text" name="platform" maxlength="100" autocomplete="off" required />
                            </div>
